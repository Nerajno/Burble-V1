describe("", () =>{
    it("Searches and plays a movie", () => {
        ...
        cy.get('a > h3').contains("The Shawshank Redemption").click({ force: true });
        //cy.wait(2000);
        ...
        cy.get('.movie-content.container div.movie-content__info div.genres').should("be.visible");
        cy.get('.movie_player').click();
    })
})
